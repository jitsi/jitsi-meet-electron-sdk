...
const { BrowserWindow, desktopCapturer, ipcMain, screen, systemPreferences } = electron;

import { SCREEN_SHARE_EVENTS_CHANNEL, SCREEN_SHARE_EVENTS, SCREEN_SHARE_GET_SOURCES, TRACKER_SIZE } from './constants.mjs';
import { isMac, isWayland } from './utils.mjs';
