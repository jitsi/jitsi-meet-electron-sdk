...
import { SCREEN_SHARE_EVENTS_CHANNEL, SCREEN_SHARE_EVENTS, SCREEN_SHARE_GET_SOURCES } from './constants.mjs';
import { logWarning, setLogger } from './utils.mjs';
 ...
 * @param {JitsiIFrameApi} api - The Jitsi Meet iframe api object.
 */
export default function setupScreenSharingRender(api, loggerTransports = null) {
